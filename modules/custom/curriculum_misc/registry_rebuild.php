 ...
 * Oh so secure... 
 */
if (!isset($_GET['s']) || empty($_GET['s']) || $_GET['s'] !== 'jfdksl21!') {
  header('HTTP/1.0 404 Not Found');
  // exit('Fatal error: Class \'DrupalDefaultEntityController\' not found in /yo/mamma/loves/drupal/htdocs/modules/user/user.module on line 300');
  exit();
}
...
function registry_rebuild_rebuild() {
  ...
  print "If you don't see any crazy fatal errors, your registry has been rebuilt. <a href='/'>Go Home</a><br/>\n";
}
